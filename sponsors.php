     ...
     /*$select = mysqli_query($conn,"SELECT * FROM sponsors_association");   
      while($result = mysqli_fetch_assoc($select)){*/
                                      ?>
                                        ...
                                        <article class="blog-item  col-12 col-sm-6 col-md-6 category-branding">
                                            <div class="wrap  wpb_animate_when_almost_visible wpb_fadeInUp fadeInUp">
                                                <div class="a-img">
                                                    <img src="images/sponser-2018.JPG" class="attachment-large size-large" alt="" loading="lazy" style="height:100%;"/>
                                       ...
                                       <article class="blog-item  col-12 col-sm-6 col-md-6 category-branding">
                                            <div class="wrap  wpb_animate_when_almost_visible wpb_fadeInUp fadeInUp">
                                                <div class="a-img">
                                                    <img src="images/sponser-2019.JPG" class="attachment-large size-large" alt="" loading="lazy" style="height:100%;"/>
                                                    <a href="" data-magic-cursor="link-w-text" data-magic-cursor-text="View"></a>
                                                </div>
                                              <!--<div class="a-img">
                                                    <img width="769" height="1024" src="ejnff/sponsers_association/<?php echo 'xyz'.$result['id'].'.jpg';?>" class="attachment-large size-large" alt="" loading="lazy" style="height:150px;"/>
