...
<div class="heading-block heading-5cdd2723f9933 tal h-h1 vc_custom_1557997482100" style="margin-top:100px; text-align:center;">
  ...
  <h1 class="h">Our <span> Management Team </span></h1>
                                </div>
<!--title-->
...
<div class="filters filter-button-group">
    <ul>
      ...
      <li><a href="javascript:void(0);" data-filter="event">Patron</a></li>
      <li><a href="javascript:void(0);" data-filter="jurry">Jurry</a></li>
       <li><a href="javascript:void(0);" data-filter="Creative resional Head">Creative resional Head</a></li>
...
<div id="container" class="isotope">
   ...
   <?php
    $event1 = mysqli_query($conn, "SELECT * FROM `event_management");
    while ($event11 = mysqli_fetch_assoc($event1)) {
    ?>
        <div class="grid-item" data-filter="event">
            <span class="popupimg" href="ejnff/jurry/<?php echo $event11['image']; ?>">
                <img src="ejnff/event_management/<?php echo $event11['image']; ?>">
            </span>
            <div class="overlay"><?php echo $event11['title']; ?></div>
        </div>
   ...
   <?php
    $jurry = mysqli_query($conn, "SELECT * FROM `jurry`");
    while ($jurry11 = mysqli_fetch_assoc($jurry)) {
    ?>
        <div class="grid-item" data-filter="jurry">
            <span class="popupimg" href="ejnff/jurry/<?php echo $jurry11['image']; ?>">
                <img src="ejnff/jurry/<?php echo $jurry11['image']; ?>">
            </span>
            <div class="overlay"><?php echo $jurry11['description']; ?></div>
        </div>
...
<div class="grid-item" data-filter="<?php echo $founder11['designation']; ?>">
  ...
  <!--Creative resional Head-->
    								<?php
                                    $founder1 = mysqli_query($conn, "SELECT * FROM team where designation = 'Creative resional Head' ");
                                    while ($founder11 = mysqli_fetch_assoc($founder1)) {
                                    ?>
									<div class="grid-item" data-filter="<?php echo $founder11['designation']; ?>">
      								  <span class="popupimg" href="ejnff/team/<?php echo $founder11['photo']; ?>">
